...
export const str_utf8_length = (str: string) => unescape(encodeURIComponent(str)).length;
...
// TODO: Check this function for any errors
...
*/
// TODO: Come check the return type of this function
export function normalizeTarget(target: URI | string, domain?: string): string | URI | undefined {
...
export function headerize(string: string): string {
  const exceptions = {
    'Call-Id': 'Call-ID',
    'Cseq': 'CSeq',
  ...
  // TODO: Come and check these ignore to c if they work
  // @ts-ignore
  if (exceptions[hname]) {
    // @ts-ignore
...
export function sipErrorCause(status_code: number) {
...
*/
export function getRandomTestNetIP() {
  function getOctet(from: number, to: number) {
...
export function calculateMD5(string: string): string {
  ...
  function doF(x: any, y: any, z: any) {
    return (x & y) | ((~x) & z);
  }

  function doG(x: any, y: any, z: any) {
    return (x & z) | (y & (~z));
  }

  function doH(x: any, y: any, z: any) {
    return (x ^ y ^ z);
  }

  function doI(x: any, y: any, z: any) {
    return (y ^ (x | (~z)));
  }

  function doFF(a: any, b: any, c: any, d: any, x: any, s: any, ac: any) {
    a = addUnsigned(a, addUnsigned(addUnsigned(doF(b, c, d), x), ac));

    return addUnsigned(rotateLeft(a, s), b);
  }

  function doGG(a: any, b: any, c: any, d: any, x: any, s: any, ac: any) {
    a = addUnsigned(a, addUnsigned(addUnsigned(doG(b, c, d), x), ac));

    return addUnsigned(rotateLeft(a, s), b);
  }

  function doHH(a: any, b: any, c: any, d: any, x: any, s: any, ac: any) {
    a = addUnsigned(a, addUnsigned(addUnsigned(doH(b, c, d), x), ac));

    return addUnsigned(rotateLeft(a, s), b);
  }

  function doII(a: any, b: any, c: any, d: any, x: any, s: any, ac: any) {
...
export function closeMediaStream(stream?: MediaStream) {
  ...
  try {
    ...
    //   stream.stop();
    // }
    console.log("Error occured when closing Media Stream: ", error)
  }
};
...
// TODO: Check out this fallback property
export function cloneObject(obj: any, fallback?: any): any {
  if (obj) {
