...
export class Transport {
  ...
  _onDisconnect(error: any, code: any, reason: any) {
    this.status = C.STATUS_DISCONNECTED;
    this.ondisconnect({
      socket: this.socket,
      error,
  ...
  _onData(data: any) {
    ...
    // Binary message.
      ...
      try {
        ...
        // TODO: Come back and solve this error of ts-ignore
        // @ts-ignore
    ...
    this.newCustomData({ transport: this, message: data })
