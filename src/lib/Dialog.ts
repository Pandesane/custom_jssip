...
import { DialogRequestSender as Dialog_RequestSender } from "./Dialog/RequestSender"
...
export class Dialog {
  ...
  constructor(owner: any, message: any, type: any, state: any = C.STATUS_CONFIRMED) {
    this._owner = owner;
    this._ua = owner._ua;
  ...
  // RFC 3261 12.2.1.1.
  _createRequest(method: any, extraHeaders: any, body: any) {
  ...
  // RFC 3261 12.2.2.
  _checkInDialogRequest(request: any) {
