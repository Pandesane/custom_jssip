...
export class OutgoingRequest {
  ...
  constructor(method: string, ruri: URI, ua: any, params?: any, extraHeaders?: any, body?: string) {
...
export class InitialOutgoingInviteRequest extends OutgoingRequest {
  transaction: any

  constructor(ruri: URI, ua: any, params?: any, extraHeaders?: any, body?: string) {
...
export class IncomingMessage {
  method: string | null;
  from: NameAddrHeader | null;
  to: NameAddrHeader | null;
  body: string | null;
  data: any;
  headers: any;
  via: any;
  ...
  */
  parseHeader(name: string, idx: number = 0): any {
    name = Utils.headerize(name);
...
export class IncomingRequest extends IncomingMessage {
  ...
  */
  reply(code: any, reason: any, extraHeaders: any, body: any, onSuccess: any, onFailure: any) {
    const supported = [];
  ...
  * -param {String} reason reason phrase
  */
  reply_sl(code: any = null, reason: any = null) {
    const vias = this.getHeaders('via');
